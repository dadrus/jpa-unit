...
public class FeatureResolverTest {
    ...
    public void testSeedDataIsDisabledForClassWithoutInitialDataSetAnnotationn() throws Exception {
        ...
        // WHEN
        final FeatureResolver resolver = FeatureResolver.newFeatureResolver(cut).withTestMethod(method).build();
    ...
    public void testCleanupBeforeTestIsEnabledForClassWithoutCorrespondingAnnotationsIfConfiguredAsDefaultPhase() throws Exception {
        ...
        // WHEN
        final FeatureResolver resolver = FeatureResolver.newFeatureResolver(cut).withTestMethod(method)
                .withDefaultCleanupPhase(CleanupPhase.BEFORE).build();
