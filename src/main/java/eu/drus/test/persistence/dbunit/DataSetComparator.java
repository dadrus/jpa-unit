...
import static eu.drus.test.persistence.dbunit.DataSetUtils.extractColumnNames;
import static eu.drus.test.persistence.dbunit.DataSetUtils.extractColumnsNotSpecifiedInExpectedDataSet;
import static eu.drus.test.persistence.dbunit.DataSetUtils.extractNonExistingColumns;
...
import eu.drus.test.persistence.dbunit.dataset.TableWrapper;
