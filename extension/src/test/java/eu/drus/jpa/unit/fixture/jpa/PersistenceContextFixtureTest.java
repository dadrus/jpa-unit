...
public class PersistenceContextFixtureTest {
    ...
    public void testApplyEntityManagerInjection() throws Throwable {
        ...
        final PersistenceContextFixture fixture = new PersistenceContextFixture();
